...
final class ToolLoopOrchestrator {
    ...
    ToolLoopOrchestrator(
        ...
        this(toolRegistry, modelClient, permissionChecker, serviceRegistry, objectMapper,
            maxToolIterations, usageAccumulator, stopReasonResolver, budgetEnforcer, responsePersistence, null, NoOpFileChangeListener.INSTANCE);
    }
    ...
    ToolLoopOrchestrator(
        ...
        this(toolRegistry, modelClient, permissionChecker, serviceRegistry, objectMapper,
            maxToolIterations, usageAccumulator, stopReasonResolver, budgetEnforcer, responsePersistence, subAgentContext, NoOpFileChangeListener.INSTANCE);
    }

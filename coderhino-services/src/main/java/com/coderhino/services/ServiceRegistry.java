...
public final class ServiceRegistry implements CommandServices, ToolServices {
    ...
    public static ServiceRegistry createDefault(Path cwd) {
        return createEmbeddedDefault(cwd);
    }

    public static ServiceRegistry createEmbeddedDefault() {
        return createEmbeddedDefault(Path.of("").toAbsolutePath().normalize());
    }

    public static ServiceRegistry createEmbeddedDefault(Path cwd) {
        return new ServiceRegistry(
            ...
            new NoOpPluginService(),
            new NoOpSkillService(),
            new NoOpCoordinatorService(),
            new NoOpProactiveService(),
            new NoOpCronScheduler(),
            new NoOpRemoteTriggerService(),
            new NoOpVoiceService(),
            new NoOpSettingsSyncService(),
            new NoOpTeamMemoryService()
        );
    }

    public static ServiceRegistry createAppDefault(Path cwd, ServerService server) {

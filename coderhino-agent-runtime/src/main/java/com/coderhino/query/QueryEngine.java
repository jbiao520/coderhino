...
public final class QueryEngine {
    ...
    public QueryEngine(ToolRegistry toolRegistry, ModelClient modelClient, PermissionChecker permissionChecker,
        ...
        this(toolRegistry, modelClient, permissionChecker, contextCollector, serviceRegistry, customSystemPrompt, appendSystemPrompt, null);
    }

    public QueryEngine(ToolRegistry toolRegistry, ModelClient modelClient, PermissionChecker permissionChecker,
                       ContextCollector contextCollector, ServiceRegistry serviceRegistry,
                       String customSystemPrompt, String appendSystemPrompt, ToolCommandRegistry commandRegistry) {
        this(
            toolRegistry,
            modelClient,
            permissionChecker,
    ...
    public QueryEngine(ToolRegistry toolRegistry, ModelClient modelClient, PermissionChecker permissionChecker,
                       ContextCollector contextCollector, ServiceRegistry serviceRegistry,
                       String customSystemPrompt, String appendSystemPrompt,
                       int maxToolIterations, double maxBudgetUsd, ToolCommandRegistry commandRegistry) {
        this(
            toolRegistry,
            modelClient,
            permissionChecker,
    ...
    public QueryEngine(ToolRegistry toolRegistry, ModelClient modelClient, PermissionChecker permissionChecker, ContextCollector contextCollector, ServiceRegistry serviceRegistry, SubAgentContext subAgentContext, ToolCommandRegistry commandRegistry) {
        this(toolRegistry, modelClient, permissionChecker, contextCollector, serviceRegistry, new ObjectMapper(), DEFAULT_MAX_TOOL_ITERATIONS, 0.0, subAgentContext, null, null, commandRegistry);
    }
    ...
    QueryEngine(
        ...
        this(toolRegistry, modelClient, permissionChecker, contextCollector, serviceRegistry, objectMapper, maxToolIterations, maxBudgetUsd, subAgentContext, customSystemPrompt, appendSystemPrompt, null);
    }
    ...
    QueryEngine(
        ...
        this.toolLoopOrchestrator = new ToolLoopOrchestrator(
            ...
            responsePersistence,
            subAgentContext,
            NoOpFileChangeListener.INSTANCE,
            commandRegistry
        );
    }
